// import { AC_ADD_LEAVE, AC_HANDLECHANGE_LEAVE, AC_VIEW_LEAVE, AC_VIEW_LEAVE } from '../../../actions/Leave.js'
...
const Leave = () => {
    ...
    const data = {
        listLeave: listLeaveReducer.listLeave,
        leaveType: listLeaveReducer.leave && listLeaveReducer.leave.leaveType,
        fromDate: listLeaveReducer.leave && listLeaveReducer.leave.fromDate,
        toDate: listLeaveReducer.leave && listLeaveReducer.leave.toDate,
        reason: listLeaveReducer.leave && listLeaveReducer.leave.reason,
    }
